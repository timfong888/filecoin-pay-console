...
- Related to Issue #16: Data Size and Proof Status columns
...
**PRs Included:**
- #17 - docs: add PaymentsMetric and DailyMetric calculation formulas
- #18 - feat: Add PDP storage provider enrichment to payee accounts
- #19 - feat(subgraph): add WeeklyTokenMetric entity for weekly token analytics
